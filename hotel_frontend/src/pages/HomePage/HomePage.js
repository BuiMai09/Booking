        ...
        <>
            <div style={{ marginBottom: "20px" }}>
                <img
                    ...
                    alt="slider1"
                    style={{  border: "0 none", width: "90%", height: "auto", lineHeight: "30.8px", marginLeft: "80px", marginTop:"20px", }}
                />
            </div>
            <ContainerComponent>
                <Grid sx={{ marginBottom: "20px", paddingRight: "5px" }} container spacing={0}>
                    <Grid item lg={6}>
                        <img
                            src="/images/Meritel-Hanoi-About-4.png"
                            alt="slider1"
                            style={{ border: "0 none", marginLeft: "180px", width: "60%", height: "auto" }}
                        />
                    </Grid>
                    <Grid item lg={6}>
                        <ContentIntroduce>
                            <TitleFrame>
                                ...
                                <IntroduceTitleIner>
                                    <EntryTitleIner>
                                        <NameIntr>Meritel Hotel</NameIntr>
                                        <br />
                            ...
                            <div style={{ marginLeft: "90px" }}>
                                ...
                                >
                                    ...
                                    được xem như trái tim và trung tâm của TP. Hà Nội. Với hệ thống phòng tiêu
                ...
                <Grid
                    sx={{ marginBottom: "30px", backgroundColor: "#f3f3f3", paddingRight: "16px", paddingBottom: "48px" }}
                    container
                    spacing={2}
                >
                    <div style={{ marginBottom: "30px",marginTop: "20px", textAlign: "center", width: "100%" }}>
                        <Titles>
                            <TitlesSpan
                                onClick={() => {
                                    navigate("/room");
                    ...
                    <RoomList  rooms={singleRooms} sx={{ marginLeft: "40px",marginRight: "20px" }} />
                </Grid>
                <Grid
